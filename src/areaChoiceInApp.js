...
componentDidMount() {
    ...
    return (
        ...
        <div className='area-choice-ui' id='choice-in-app-dropdown'>
            ...
            <SplitButton title="Choose Area..." pullRight id="split-button-pull-right">
        ...
        <br/>
        <h4 className='side-of-choice-in-app-content'>Check out cinemas in your area,<br/> find movies screened in English, <br/>and get info about movies in our database.</h4>
        </div>
        </div>
        </div>
